...
import  os
def train_yolo(data_config, model_path='yolov8x-seg.pt', epochs=500, batch_size=16, nms_iou_threshold=0.25):
    ...
    # Train the model
    model.train(data=data_config, epochs=epochs,batch=batch_size, single_cls = True)
    # print(model)
# Create YOLO data configuration file

data_config_path = "segmentation.yaml"

# Train YOLO model      Epoch    GPU_mem   box_loss   seg_loss  pose_loss   cls_loss   dfl_loss       kobj  Instances       Size
